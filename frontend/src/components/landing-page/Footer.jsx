  ...
  return (
    <footer id="contact-us" className="relative w-full h-screen md:h-screen bg-black overflow-hidden flex flex-col justify-between items-center font-sans select-none z-[10002] pt-10 md:pt-0 -mt-1">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-[0.12] pointer-events-none overflow-hidden flex items-center justify-center">
        <h2 className="text-[60vw] font-black text-white leading-none tracking-tighter select-none font-bebas">SANJAI</h2>
      </div>
      ...
      <div className="w-full border-t border-white/5 py-4 px-6 md:px-20 grid grid-cols-1 md:grid-cols-3 gap-6 items-end z-10 backdrop-blur-xl bg-black/80">
        <div className="space-y-2">
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <span className="text-white font-bebas text-3xl md:text-5xl leading-none tracking-wide">SANJAI</span>
              <span className="text-[#FFFF00] font-bold text-[8px] md:text-[10px] tracking-[0.4em] uppercase mt-1">FULL STACK DEVELOPER</span>
            </div>
          </div>
          <p className="text-zinc-500 text-xs md:text-sm font-medium leading-relaxed max-w-xs uppercase mt-2 md:mt-0">
            Building robust web applications and seamless mobile experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col md:items-center gap-2">
          <div className="flex gap-4 md:gap-10">
            {[
              { name: 'GitHub', url: 'https://github.com/sanjaipandian-as' },
              { name: 'LinkedIn', url: 'https://www.linkedin.com/in/sanjai-pandian-682629308/' },
              { name: 'Mail', url: 'mailto:sanjaipandian.as@gmail.com' }
            ].map((social) => (
              <a
                key={social.name}
                href={social.url}
        ...
        <div className="text-right space-y-1">
          <p className="text-white/20 text-[10px] font-black uppercase tracking-[0.3em]">© 2026 Sanjai Pandian</p>
