...
const Team = () => {
    const teamMembers = [
        {
            ...
            region: "Core Expertise",
            bio: "I build scalable and responsive web applications from scratch, handling both frontend and backend development to deliver complete solutions.",
        ...
        },
        {
            ...
            bio: "I create high-performance, cross-platform mobile applications that provide native-like experiences across all devices.",
        ...
        },
        {
            ...
            bio: "I design robust architectures and RESTful APIs, ensuring secure data flow, system reliability, and optimized database queries.",
            skills: ["MongoDB", "PostgreSQL", "Node.js"],
            image: "/sanjai.png",
            thumbnail: "/sanjai.png"
        },
        {
            ...
            bio: "During my time at Zippy Digital Solutions, I successfully delivered 3+ production-level websites and 2 mobile apps used by real clients.",
            skills: ["Production Code", "Deployment", "Agile"],
            image: "/sanjai.png",
            thumbnail: "/sanjai.png"
        }
    ];
    ...
    return (
        <div id="about" className="min-h-screen md:h-screen bg-[#111] flex items-center justify-center font-sans relative overflow-y-auto md:overflow-hidden">
            <div
                        ...
                        <div className="space-y-8 mt-4 relative z-30">
                            ...
                            >
                                <p className="text-gray-600 text-lg leading-relaxed font-medium border-l-4 border-gray-200 pl-6">
                                    I'm a dedicated Full-Stack and Mobile Developer driven by creating high-quality, production-ready applications.
                                </p>
                            </motion.div>
                        </div>
